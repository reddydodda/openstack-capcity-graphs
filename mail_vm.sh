...
function fappend {
    ...
    YYYYMMDD=`date +%Y%m%d`
     ...
     # CHANGE THESE
     TOEMAIL="reddydoda@gmail.com";
     CCEMAIL="csreddy@stylesyou.com";
     FREMAIL="info@stylesyou.com";
     SUBJECT="Daily OpenStack Capacity Reports (VM) - $YYYYMMDD";
     MSGBODY="Capacity Reports For Virtual machines: Regions List:
     #######################################################################
     # Region1 Newton 
     # Region2 Mitaka   
     # Region3 Mitaka             
